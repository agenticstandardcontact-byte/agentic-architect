...
This isn't a collection of 'prompts.' It's a directory-level configuration system.

[Get the Framework for £19.99 →](https://agenticarchitect.gumroad.com/l/dotnet-persistence-kit)

## 📬 Support & Community

* **Support**: agenticstandardcontact@gmail.com

* **Issues**: [Open a GitHub Issue](https://github.com/agentic-architect/rules/issues)
